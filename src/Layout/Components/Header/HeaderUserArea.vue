            ...
            <div class="widget-content p-0">
                <div class="widget-content-wrapper">
                        ...
                        <b-dropdown toggle-class="p-0 mr-2" menu-class="dropdown-menu-lg" variant="link" no-caret right>
                            <span slot="button-content">
                                <div class="icon-wrapper icon-wrapper-alt rounded-circle">
                                    ...
                                    <img width="42" class="rounded-circle" :src="avatar" alt="" />
                                </div>
                            </span>
                                    ...
                                    <div class="menu-header-content text-left">
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                ...
                                                <div class="widget-content-left">
                                                    <div class="widget-heading">{{ loggedUserFullName }}</div>
                    ...
                    <div class="widget-content-left  ml-3 header-user-info">
                        <div class="widget-heading">{{ loggedUserFullName }}</div>
                        <div class="widget-subheading">{{ loggedUserType }}</div>
                    </div>
...
<script>
    ...
    /*if (localStorage.getItem("avatar")) {
        var profilePic = ('http://staging-semicv2-api.tk/'+localStorage.getItem("avatar"));
    } else {
        var profilePic = '@/assets/images/avatars/1.jpg';
    }*/
...
//            'font-awesome-icon': FontAwesomeIcon,
        ...
        data: () => ({
            ...
            loggedUserFullName: loggedUser.first_name+' '+loggedUser.last_name,
            loggedUserType: 'Guest',
            avatar: localStorage.getItem("avatar")
        }),
        mounted(){
            switch(loggedUser.type) {
                case 'A':
                    this.loggedUserType = 'Assistant';
                    break;
                case 'AD':
                ...
                case 'D':
                    ...
                    break;
                case 'M':
                    this.loggedUserType = 'Med Tech';
                    break;
                default:
                    this.loggedUserType = 'Guest';
            }
        ...
        methods: {
            logout(){
                axios.get('/api/auth/logout', {
                 headers: {
                   Authorization: localStorage.getItem("loggedInToken")
                 }
                })
                .then((res) => {
