    ...
    <div class="card-shadow-primary card-border mb-3 card">
        ...
        <div class="scroll-area-sm">
            <VuePerfectScrollbar class="scrollbar-container">
                <misc-lab-result-timeline :results="user.misc_lab_results" v-on:view-log="openViewDialog">
                </misc-lab-result-timeline>
            </VuePerfectScrollbar>
        </div>
    </div>
</div>
...
import MiscLabResultTimeline from "../../../Components/MiscLabResult/Timeline";

export default {
    components: {
        VuePerfectScrollbar,
        MiscLabResultTimeline
    },
    props: ['users'],
    data: () => ({
        local_users: []
