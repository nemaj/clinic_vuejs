...
<div class="col-md-12 col-lg-6 col-xl-4" v-for="user in local_users">
    <div class="card-shadow-primary card-border mb-3 card">
        <div class="dropdown-menu-header">
            <div class="dropdown-menu-header-inner" style="background-color: #800080;">
        ...
        <div class="scroll-area-sm">
            <VuePerfectScrollbar class="scrollbar-container">
                <special-test-lab-result-timeline :results="user.special_test_lab_results" v-on:view-log="openViewDialog">
                </special-test-lab-result-timeline>
            </VuePerfectScrollbar>
        </div>
    </div>
</div>
...
import SpecialTestLabResultTimeline from "../../../Components/SpecialTestLabResult/Timeline";

export default {
    components: {
        VuePerfectScrollbar,
        SpecialTestLabResultTimeline
    },
    props: ['users'],
    data: () => ({
        local_users: []
