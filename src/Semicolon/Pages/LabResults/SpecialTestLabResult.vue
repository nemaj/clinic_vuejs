...
<div>
    ...
    <special-test-lab-result-cards :users="users" v-show="!isLoading" v-on:open-modal="openAddEditModal" v-on:view-log="openViewDialog">
    </special-test-lab-result-cards>
...
import PageTitle from './SpecialTestLabResult/PageTitle';
import SpecialTestLabResultCards from './SpecialTestLabResult/Cards';
import AddEditDialog from "../../Components/SpecialTestLabResult/AddEditDialog";
import ViewDialog from "../../Components/SpecialTestLabResult/ViewDialog";
import ErrorAlert from "../../Components/Alerts/Error.vue";

export default {
    components: {
        SpecialTestLabResultCards,
        PageTitle,
        AddEditDialog,
        ErrorAlert,
        ViewDialog
    ...
    data: () => ({
        heading: 'SpecialTest Lab Result',
        subheading: 'Users record of SpecialTest lab result',
    ...
    methods: {
    	getUsers(name = ""){
    		...
    		var params = "?include=specialtestlabresults"
