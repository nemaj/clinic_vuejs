...
<div>
    ...
    <urinalysis-cards :users="users" v-show="!isLoading" v-on:open-modal="openAddEditModal" v-on:view-log="openViewDialog">
    </urinalysis-cards>
...
import UrinalysisCards from './Urinalysis/Cards';
import AddEditDialog from "../../Components/Urinalysis/AddEditDialog";
import ViewDialog from "../../Components/Urinalysis/ViewDialog";
...
export default {
    ...
    data: () => ({
        heading: 'Urinalysis',
        subheading: 'Users record of Urinalysis',
        icon: 'pe-7s-drop icon-gradient',
        isLoading: false,
        errors: [],
        isErrorDialog: false,
    	users: [],
