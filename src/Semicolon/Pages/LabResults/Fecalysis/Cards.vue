...
<div class="col-md-12 col-lg-6 col-xl-4" v-for="user in local_users">
    <div class="card-shadow-primary card-border mb-3 card">
        <div class="dropdown-menu-header">
            <div class="dropdown-menu-header-inner" style="background-color: #a5682a;">
        ...
        <div class="scroll-area-sm">
            <VuePerfectScrollbar class="scrollbar-container">
                <fecalysis-timeline :results="user.fecalyses" v-on:view-log="openViewDialog"></fecalysis-timeline>
            </VuePerfectScrollbar>
        </div>
    </div>
</div>
...
import FecalysisTimeline from "../../../Components/Fecalysis/Timeline";
