    ...
    <div class="card-shadow-primary card-border mb-3 card">
        ...
        <div class="scroll-area-sm">
            <VuePerfectScrollbar class="scrollbar-container">
                <blood-chemistry-timeline :results="user.blood_chemistries" v-on:view-log="openViewDialog">
                </blood-chemistry-timeline>
            </VuePerfectScrollbar>
        </div>
    </div>
</div>
...
import BloodChemistryTimeline from "../../../Components/BloodChemistry/Timeline";

export default {
    components: {
        VuePerfectScrollbar,
        BloodChemistryTimeline
    },
    props: ['users'],
    data: () => ({
        local_users: []
