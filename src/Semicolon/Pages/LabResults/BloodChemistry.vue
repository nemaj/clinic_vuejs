...
<div>
    ...
    <blood-chemistry-cards :users="users" v-show="!isLoading" v-on:open-modal="openAddEditModal" v-on:view-log="openViewDialog">
    </blood-chemistry-cards>
    ...
    <blood-chemistry-add-edit-dialog v-model="showAddEditModal" :user_id="current_user_id" v-on:result-updated="getUsers">
    </blood-chemistry-add-edit-dialog>
...
import PageTitle from './BloodChemistry/PageTitle';
import BloodChemistryCards from './BloodChemistry/Cards';
import BloodChemistryAddEditDialog from "../../Components/BloodChemistry/AddEditDialog";
import ViewDialog from "../../Components/BloodChemistry/ViewDialog";
...
export default {
    components: {
        BloodChemistryCards,
        PageTitle,
        BloodChemistryAddEditDialog,
        ViewDialog,
        ErrorAlert
    },
    data: () => ({
        heading: 'Blood Chemistry',
        subheading: 'Users record of blood chemistry',
    ...
    methods: {
    	getUsers(name = ""){
    		...
    		var params = "?include=bloodchemistries"
