...
<div>
    ...
    <misc-lab-result-cards :users="users" v-show="!isLoading" v-on:open-modal="openAddEditModal" v-on:view-log="openViewDialog">
    </misc-lab-result-cards>
    ...
    <add-edit-dialog v-model="showAddEditModal" :user_id="current_user_id" v-on:result-updated="getUsers"></add-edit-dialog>
...
import PageTitle from './MiscLabResult/PageTitle';
import MiscLabResultCards from './MiscLabResult/Cards';
import ErrorAlert from "../../Components/Alerts/Error.vue";
import AddEditDialog from "../../Components/MiscLabResult/AddEditDialog";
import ViewDialog from "../../Components/MiscLabResult/ViewDialog";
...
export default {
    ...
    data: () => ({
        heading: 'Misc Lab Result',
        subheading: 'Users record of misc lab result',
    ...
    methods: {
    	getUsers(name = ""){
    		...
    		var params = "?include=misclabresults"
